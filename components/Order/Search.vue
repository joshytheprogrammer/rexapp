<template>
  <section class="flex justify-between gap-8 bg-white w-full items-center py-4 px-4 rounded-md shadow-lg border ">
    <h2 class="hidden md:block w-fit text-xl lg:text-2xl font-normal">Track your Order</h2>
